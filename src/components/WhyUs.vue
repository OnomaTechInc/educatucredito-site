<template>
  <v-container fluid id="whyus">
    ...
    <section class="whyUs">
      <div class="container">
        <div class="info-box">
          <p v-html="translationText.whyusp1"></p>
          <p v-html="translationText.whyusp2"></p>
          <p v-html="translationText.whyusp3"></p>
          <div class="list">
            <p v-html="translationText.whyusp4"></p>
            <ul>
          ...
          <p v-html="translationText.whyusp5"></p>
          <p v-html="translationText.whyusp6"></p>
        </div>
      </div>
    </section>
  </v-container>
      ...
      translation (val) {
        if (val === 'en') {
          this.translationText = {
            ...
            whyusp4: 'These are some of accomplishments and proven effective methods that  we have so far as we give 100% satisfaction to all of our clients who have tremendous change in their financial aspect of life.',
            ...
            whyusp5: 'All of these are representations of our personal commitment towards customer satisfaction,  genuine concern and care to help individuals cope up and overcome financial difficulties. We help them achieve incredible change in their financial lifestyle',
            whyusp6: 'Why wait? It only takes a minute to <a href=#/register>sign up</a>. Your information is safe with us. We treat your data as if it were our own. Start the path to a better financial future. <a href=tel:813-444-5539>Call us now!</a>'
          }
        } else if (val === 'es') {
          this.translationText = {
